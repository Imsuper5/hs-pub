        ...
        slimScroll: function(h) {
            ...
            this.each(function() {
                ...
                function m(d, f, h) {
                    ...
                    e = l * ((b[0].scrollHeight-13) - b.outerHeight());
                    h && (e = d, d = e / (b[0].scrollHeight-13) * b.outerHeight(), d = Math.min(Math.max(d, 0), g), c.css({
                        top: d + "px"
                    }));
                    b.scrollTop(e);
                ...
                function w() {
                    u = Math.max(b.outerHeight() / (b[0].scrollHeight-13) * b.outerHeight(), D);
                    c.css({
                        height: u + "px"
                    });
