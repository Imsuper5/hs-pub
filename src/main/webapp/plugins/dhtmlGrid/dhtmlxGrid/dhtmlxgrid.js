...
function dhtmlXGridObject(a) {
        ...
        if (!this._hrrar || !this._hrrar[this.r_fldSorted ? this.r_fldSorted._cellIndex : a])
            if (f || (f = a ? this.hdr.rows[c || 0].cells[a] : this.r_fldSorted), f != null) {
                var d = this.getPosition(f, this.hdrBox),
                    h = f.offsetWidth;
                this.sortImg.style.left = Number(d[0] + h -9) + "px";
                this.sortImg.defLeft = parseInt(this.sortImg.style.left);
                this.sortImg.style.top = Number(d[1] + 17) + "px";
    ...
    this.moveToVisible = function(a, b) {
        ...
        try {
            ...
            if (l > this.objBox.offsetHeight + this.objBox.scrollTop) var k = d;
                ...
                (k = d - 5); if (k) this.objBox.scrollTop = k
        } catch (m) {}
    };
    ...
    this.copyRowContent = function(a, b) {
        ...
        if (this.isTreeGrid()) this._copyTreeGridRowContent(c, a, b);
            ...
            for (var d = 0; d < c.cells.length; d++) this.cells(b, d).setValue(this.cells(a, d).getValue()); if (!_isIE) this.getRowById(a).cells[0].height =
...
dhtmlXGridObject.prototype = {
    ...
    _hideShowColumn: function(a, b) {
        ...
        if (b == "none") {
            ...
            this._fixHiddenRowsAll(this.hdr, a, "display", "none", "_cellIndexS")&&(_isOpera && _OperaRv < 9 || _isKHTML ||
                _isFF);
