...
function(a) {
    ...
    m = function() {
        ...
        this.insertImage = function(a, b) {
            if(a[0].innerHTML.indexOf("<img")>=0)
         	   alert("已存在图片!");  
         	else if(b.indexOf("image/jpeg")==-1  && b.indexOf("image/png")==-1 && b.indexOf(".png")==-1 && b.indexOf(".jpg")==-1)
          	   alert("只支持jpeg、png格式的图片 !"); 
         	else
